    ...
    <div class="p-6 overflow-x-auto">
        ...
        <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
            ...
            <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50 transition-colors">
                ...
                <Link :href="route('user.show', user.id)"><td class="py-3 px-4 font-medium">{{ user.name }}</td></Link>
              ...
              >
                ...
                <td><button class="text-red-600 hover:text-red-800" @click="destroy(user)">Удалить</button></td>
            </tr>
            </tbody>
        </table>
    </div>
